    ...
    <div className="about-page">
      ...
      <section className="section-padding bg-primary">
        <div className="container" style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <p className="text-xl fw-bold text-primary mb-6">
            Nuestro Lema es claro: VESTÍ CON PROPOSITO.
          </p>
          <p className="text-lg text-muted mb-6">
            Cada prenda es una forma de llevar la Palabra a lo cotidiano — en la universidad, en el trabajo, en la calle.
          </p>
          <p className="text-lg text-muted mb-6">
            Además, todas nuestras remeras son 100% personalizables.<br/>
      ...
      <section className="section-padding about-cta" style={{ backgroundColor: 'var(--bg-secondary)' }}>
        <div className="container text-center">
          <h2 className="text-4xl fw-bold mb-6">Llevando el mensaje a todos lados</h2>
          <p className="text-lg text-muted mb-8 max-w-2xl mx-auto">
            Explora nuestra última colección y eleva tu guardarropa con un mensaje eterno.
          </p>
          <Link to="/shop">
